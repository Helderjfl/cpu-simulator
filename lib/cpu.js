...
var cpu = {
	...
	step: function() {
		...
		switch(cpu.state) {
			...
			case 0:
				setState(1, "Busca", "A *Unidade de Controle* copia o valor do registrador *PC* para o registrador *MAR* e para o *Barramento de Endereço*");
				...
				break;
			case 1:
				setState(2, "Busca", "The *Control Unit* tells the memory store to look at the address on the *Address Bus* and load the value stored there onto the *Data Bus*");
				$('.active').removeClass('active');
				$('#ram_value_' + cpu.registers.mar).addClass('active');
			break;
			
			case 2:
				setState(3, "Busca", "The *Control Unit* stores the value on the *Data Bus* into the *Memory Data Register*");
			...
			case 3:
				setState(4, "Busca", "The *Control Unit* copies the value from the *Memory Data Register* into the *Current Instruction Register*");
			...
			case 4:
				setState(5,"Busca", "The *Control Unit* increments the *Program Counter*");
				cpu.registers.pc++;
				cpu.updateValues();
				$('.active').removeClass('active');
	...
	updateAnnotations: function() {
		...
		connect({e:CPU, h:"right", v:"5%"}, {e: RAM, h:"left"}, {"stroke-width": 25, "stroke": "#F00", "arrow-end":"block-narrow-short"}, "Barramento de endereço", {"font-size": 16});
		connect({e:CPU, h:"right", v:"56%"}, {e: RAM, h:"left"}, {"stroke-width": 25, "stroke": "#F00", "arrow-end":"block-narrow-short", "arrow-start": "block-narrow-short"}, "Barramento de dados", {"font-size": 16});
		connect({e:CPU, h:"right", v:"85%"}, {e: RAM, h:"left"}, {"stroke-width": 25, "stroke": "#F00", "arrow-end":"block-narrow-short", "arrow-start": "block-narrow-short"}, "Barramento de controle", {"font-size": 16});
	},
	...
	init: function(jqCPU) {
		...
		html += '<table class="table table-fixed table-striped table-hover"><thead><tr><th class="col-sm-6">Endereço</th><th class="col-sm-6">Valor</th></tr></thead>';
